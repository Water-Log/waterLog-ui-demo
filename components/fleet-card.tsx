...
export function FleetCard({ 
  ...
  const fleetShips = showWaterAnalysis ? Object.values(waterAnalysisData).filter(ship => ship.fleetId === fleet.id) : []

  if (showWaterAnalysis && waterAnalysis) {
    // Water Analysis Version (for Fleet Management page)
    return (
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-semibold flex items-center gap-2">
                  ...
                  Ships Status Detail ({fleetShips.length} ships)
                </h4>
                <Button
                  variant="ghost"
                  size="sm"
  ...
  // Simple Version (for Manager Dashboard)
  return (
